...
const DISCORD_CLIENT_ID = 'YOUR_CLIENT_ID';        // Get from Discord Developer Portal
const DEFAULT_SERVER = {
    host: 'SHADOWSMP-yDJL.aternos.me',  // CHANGE THIS
    port: 44363                          // CHANGE THIS
};

let currentServer = { ...DEFAULT_SERVER };
let minecraftClient = null;
let chatInterval = null;
let customMessage = 'Shadow SMP the coolest of all time';
